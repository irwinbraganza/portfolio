  ...
  return (
    <Section className="pt-20 md:pt-28 lg:pt-32 pb-16 md:pb-20">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        <div>
          <p className="text-sm md:text-base text-forest-800 dark:text-forest-300 font-semibold mb-4">
            Welcome
          </p>
          ...
          <blockquote className="mb-8 pl-6 border-l-4 border-forest-800 dark:border-forest-300">
        ...
        <div className="hidden lg:block">
          <div className="aspect-square rounded-lg bg-gradient-to-br from-forest-100 dark:from-forest-950 to-neutral-100 dark:to-neutral-800 flex items-center justify-center">
            <div className="text-center">
              <div className="text-6xl font-bold text-forest-800 dark:text-forest-300 opacity-10">
                {"</>"}
              </div>
