import { Profile, Projects, Architecture } from './types';
...
export async function getProfile(): Promise<Profile> {
  return fetchWithFallback<Profile>('/api/profile', DEFAULT_PROFILE);
}

export async function getProjects(): Promise<Projects> {
  return fetchWithFallback<Projects>('/api/projects', DEFAULT_PROJECTS);
}

export async function getArchitecture(): Promise<Architecture> {
  return fetchWithFallback<Architecture>('/api/architecture', DEFAULT_ARCHITECTURE);
}
